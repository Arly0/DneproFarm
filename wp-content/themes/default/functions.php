...
function default_scripts() {
    ...
    wp_enqueue_script( 'js-libs', get_template_directory_uri() . '/js/libs.min.js', array(), '', true );
    wp_enqueue_script( 'js-app', get_template_directory_uri() . '/js/scripts.min.js', array('js-libs'), '', true );
