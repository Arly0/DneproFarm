...
<head>
    ...
    <base href="<?php echo get_template_directory_uri() . '/' ?>" target="_blank">
    <!--Styles-->
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/css/libs.min.css" type="text/css">
...
<div id="vue-menu">
    <div v-if="showMenu" class="darkside"></div>
    <div v-if="showMenu"  class="menu_mob">
        <div class="menu__close" @click="showMenu = !showMenu">
        ...
        <div class="content">
            ...
            <div class="contacts">
                            ...
                            <div class="language">
                                <div @click="selectLang = !selectLang" class="lang__select d-flex">
                                    <p>Укр</p>
                                    <img src="images/arrow_down.png" alt="Більше">
                                </div>

                                <div v-if="selectLang" class="lang__block">
                                    <div>
                                        Рус
                                    </div>
                                    <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <div class="burger showMob" @click="showMenu = !showMenu">
